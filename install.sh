...
if [ "$(uname -m)" = "armv7l" ]; then
  ...
  echo "https://github.com/LittlelambocoinNetwork/littlelambocoin-blockchain/wiki/Raspberry-Pi"
  echo "Exiting."
  exit 1
fi
# Get submodules
...
echo "https://github.com/LittlelambocoinNetwork/littlelambocoin-blockchain/wiki/Quick-Start-Guide"
echo ""
