...
if [ "$(uname -m)" = "armv7l" ]; then
  ...
  echo "https://github.com/BTCgreen-Network/littlelambocoin-blockchain/wiki/Raspberry-Pi"
  echo "Exiting."
  exit 1
fi
# Get submodules
...
if [ "$PYTHON_MAJOR_VER" -ne "3" ] || [ "$PYTHON_MINOR_VER" -lt "7" ] || [ "$PYTHON_MINOR_VER" -ge "11" ]; then
  echo "Littlelambocoin requires Python version >= 3.7 and  < 3.11.0" >&2
...
echo "https://github.com/BTCgreen-Network/littlelambocoin-blockchain/wiki/Quick-Start-Guide"
echo ""
