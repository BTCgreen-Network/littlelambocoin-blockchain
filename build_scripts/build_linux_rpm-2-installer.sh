...
echo electron-builder build --linux rpm "${OPT_ARCH}" \
  ...
  --config.rpm.packageName="littlelambocoin-blockchain"
...
GUI_RPM_NAME="littlelambocoin-blockchain-${LITTLELAMBOCOIN_INSTALLER_VERSION}-1.${REDHAT_PLATFORM}.rpm"
mv "dist/${PRODUCT_NAME}-${LITTLELAMBOCOIN_INSTALLER_VERSION}.rpm" "../../../build_scripts/dist/${GUI_RPM_NAME}"
