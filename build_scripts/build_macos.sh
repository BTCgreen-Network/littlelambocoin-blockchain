...
if [ "$NOTARIZE" == true ]; then
  electron-osx-sign Littlelambocoin-darwin-x64/Littlelambocoin.app --platform=darwin \
...
mv Littlelambocoin-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Littlelambocoin-$SHIBGREEN_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Littlelambocoin-darwin-x64/Littlelambocoin.app Littlelambocoin-$SHIBGREEN_INSTALLER_VERSION \
