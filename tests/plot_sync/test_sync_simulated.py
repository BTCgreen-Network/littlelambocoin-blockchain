...
from littlelambocoin.plot_sync.util import Constants
from littlelambocoin.plotting.manager import PlotManager
from littlelambocoin.plotting.util import PlotInfo
from littlelambocoin.protocols.harvester_protocol import PlotSyncError, PlotSyncResponse
...
from littlelambocoin.util.ints import int16, uint64
...
async def skip_processing(self: Any, _: WSLittlelambocoinConnection, message_type: ProtocolMessageTypes, message: Any) -> bool:
...
async def _testable_process(
    self: Any, peer: WSLittlelambocoinConnection, message_type: ProtocolMessageTypes, message: Any
) -> None:
