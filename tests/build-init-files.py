...
# Create missing `__init__.py` files in the source code folders (in "littlelambocoin/" and "tests/").
#
...
def command(verbose, root_str):
    ...
    tree_roots = ["benchmarks", "build_scripts", "littlelambocoin", "tests", "tools"]
    failed = False
