...
from littlelambocoin.pools.pool_config import PoolWalletConfig
from littlelambocoin.util.config import create_default_littlelambocoin_config, load_config, lock_config, save_config
...
def test_pool_config(tmp_path):
    ...
    create_default_littlelambocoin_config(test_root, ["config.yaml"])
