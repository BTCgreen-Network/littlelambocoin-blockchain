...
from littlelambocoin.daemon.keychain_server import DeleteLabelRequest, SetLabelRequest
from littlelambocoin.daemon.server import WebSocketServer, service_plotter
...
from littlelambocoin.util.keychain import KeyData
from littlelambocoin.daemon.keychain_server import GetKeyRequest, GetKeyResponse, GetKeysResponse
...
from littlelambocoin.simulator.time_out_assert import time_out_assert_custom_interval, time_out_assert
...
def mock_daemon_with_services():
    ...
    return Daemon(
        services={
            ...
            "littlelambocoin_plotter": [Service(True), Service(True)],
        },
        connections={},
    )
