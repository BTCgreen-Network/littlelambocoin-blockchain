...
from littlelambocoin.types.weight_proof import WeightProof, SubEpochData, SubEpochChallengeSegment, SubSlotData, RecentChainData
...
from littlelambocoin.types.blockchain_format.foliage import Foliage, FoliageTransactionBlock, FoliageBlockData, TransactionsInfo

from littlelambocoin.protocols import (
    farmer_protocol,
    full_node_protocol,
    harvester_protocol,
    introducer_protocol,
...
pool_target = PoolTarget(
    bytes32.from_hexstr("ca57868a01ad8c49a786049175cfcb13cae445380cc0cfc724c7ecf9bf8b718c"),
    uint32(421941852),
)
