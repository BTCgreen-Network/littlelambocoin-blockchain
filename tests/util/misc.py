...
class _AssertRuntime:
    ...
    Produces output of the following form.
        ...
        /home/altendky/repos/littlelambocoin-blockchain/tests/core/full_node/test_performance.py:187
...
@contextlib.contextmanager
def closing_littlelambocoin_root_popen(littlelambocoin_root: LittlelambocoinRoot, args: List[str]) -> Iterator[subprocess.Popen[Any]]:
