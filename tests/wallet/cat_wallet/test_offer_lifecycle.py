...
# This method takes a dictionary of strings mapping to amounts and generates the appropriate CAT/LLC coins
...
class TestOfferLifecycle:
    ...
    async def test_complex_offer(self, setup_sim):
        ...
        try:
            ...
            littlelambocoin_coins: List[Coin] = all_coins[None]
            ...
            # Create an LLC Offer for RED
            littlelambocoin_requested_payments: Dict[Optional[bytes32], List[Payment]] = {
            ...
            littlelambocoin_requested_payments: Dict[Optional[bytes32], List[NotarizedPayment]] = Offer.notarize_payments(
                littlelambocoin_requested_payments, littlelambocoin_coins
            )
            littlelambocoin_announcements: List[Announcement] = Offer.calculate_announcements(littlelambocoin_requested_payments, driver_dict)
            littlelambocoin_secured_bundle: SpendBundle = generate_secure_bundle(littlelambocoin_coins, littlelambocoin_announcements, 1000)
            littlelambocoin_offer = Offer(littlelambocoin_requested_payments, littlelambocoin_secured_bundle, driver_dict)
            assert not littlelambocoin_offer.is_valid()

            # Create a RED Offer for LLC
            ...
            new_offer = Offer.aggregate([littlelambocoin_offer, red_offer, red_offer_2])
            ...
            # Create yet another offer of BLUE for LLC and RED
            ...
            assert new_offer.summary() == (
                ...
                {"llc": 900, str_to_tail_hash("red").hex(): 350},
