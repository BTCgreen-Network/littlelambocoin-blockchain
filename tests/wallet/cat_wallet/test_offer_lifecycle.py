...
class TestOfferLifecycle:
    ...
    async def test_complex_offer(self, setup_sim):
        ...
        try:
            ...
            littlelambocoin_announcements: List[Announcement] = Offer.calculate_announcements(littlelambocoin_requested_payments)
            littlelambocoin_secured_bundle: SpendBundle = self.generate_secure_bundle(littlelambocoin_coins, littlelambocoin_announcements, 1000)
            littlelambocoin_offer = Offer(littlelambocoin_requested_payments, littlelambocoin_secured_bundle)
            ...
            new_offer = Offer.aggregate([littlelambocoin_offer, red_offer])
