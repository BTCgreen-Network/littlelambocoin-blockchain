...
import { useGetLoggedInFingerprintQuery, useGetPrivateKeyQuery, useGetWalletsQuery } from '@littlelambocoin/api-react';
import {
  Flex,
  CardListItem,
  useOpenDialog,
          ...
          <ActionsStyled>
            <Flex gap={3} flexDirection="column" width="100%">
              <Button
                ...
                size="large"
                onClick={() =>
                  openExternal(`https://cat1.littlelambocoin.com/#publicKey=${privateKey.pk}&fingerprint=${fingerprint}`)
                }
