...
import { useSetCATNameMutation } from '@littlelambocoin/api-react';
...
import { Tooltip, CardListItem, Flex, Link, useShowError } from '@littlelambocoin/core';
...
export default function WalletTokenCard(props: WalletTokenCardProps) {
  ...
  const currentName = walletType === WalletType.STANDARD_WALLET ? 'Littlelambocoin' : name;
