import { useGetSyncStatusQuery, useSendTransactionMutation, useFarmBlockMutation } from '@littlelambocoin/api-react';
import {
  AdvancedOptions,
  Amount,
  ButtonLoading,
...
export default function WalletSend(props: SendCardProps) {
  ...
  async function handleSubmit(data: SendTransactionData) {
    ...
    const queryData = {
      walletId,
      address,
      amount: littlelambocoinToMojo(amount),
      fee: littlelambocoinToMojo(fee),
