import { Amount, Form, AlertDialog, Back, Card, Flex, ButtonLoading, littlelambocoinToMojo } from '@littlelambocoin/core';
...
export default function WalletDIDCreate() {
  ...
  async function onSubmit(data) {
    try {
      ...
      const amount_val = littlelambocoinToMojo(data.amount);
