import { AlertDialog, Card, Flex, Loading, Dropzone, mojoToLittlelambocoinLocaleString } from '@littlelambocoin/core';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">{mojoToLittlelambocoinLocaleString(props.balance)} TLLC</Typography>
        </Box>
      </Box>
    </Grid>
  );
