...
import { Flex, Loading, MenuItem, useOpenDialog } from '@littlelambocoin/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@littlelambocoin/api-react';
import { Offers as OffersIcon } from '@littlelambocoin/icons';
