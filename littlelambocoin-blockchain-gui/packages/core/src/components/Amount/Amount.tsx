...
import littlelambocoinToMojo from '../../utils/littlelambocoinToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isLittlelambocoinCurrency = ['LLC', 'TLLC'].includes(currencyCode);
  const mojo = isLittlelambocoinCurrency ? littlelambocoinToMojo(correctedValue) : catToMojo(correctedValue);
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isLittlelambocoinCurrency ? 12 : 3,
