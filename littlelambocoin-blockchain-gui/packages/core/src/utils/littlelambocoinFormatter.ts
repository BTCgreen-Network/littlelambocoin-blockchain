...
class Littlelambocoin {
  ...
  to(newUnit: Unit) {
    ...
    return new Littlelambocoin(newValue, newUnit);
  }
...
export default function littlelambocoinFormatter(value: number | string | BigNumber, unit: Unit) {
  return new Littlelambocoin(value, unit);
}
