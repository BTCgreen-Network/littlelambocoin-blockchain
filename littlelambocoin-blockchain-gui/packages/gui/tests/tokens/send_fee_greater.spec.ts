...
test('Confirm that User cannot send a TLLC fee greater then in Wallet', async () => {
  ...
  await page.locator('text=Fee *TLLC >> input[type="text"]').fill('10');
  ...
  await expect(page.locator('text=Pending Change0 TLLC')).toBeVisible();
});
