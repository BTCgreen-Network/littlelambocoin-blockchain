...
test('Confirm that User cannot send a TLLC amount greater then in Wallet', async () => {
  let receive_wallet = 'tllc1u237ltq0pp4348ppwv6cge7fks87mn4wz3c0ywvgswvpwhkqqn8qn8jeq6';
  ...
  console.log(`LLC Balance: ${balance}`);
  ...
  await page.locator('text=Fee *TLLC >> input[type="text"]').fill('0.000005');
  ...
  await expect(page.locator('text=Pending Balance0 TLLC')).toBeVisible();
});
