...
test('Create new Wallet and logout', async () => {
  ...
  // assert.equal(page.url(), 'file:///Users/jahifaw/Documents/Code/Littlelambocoin-testnet-playwright/littlelambocoin-blockchain/littlelambocoin-blockchain-gui/packages/gui/build/renderer/index.html#/wallet/add');
