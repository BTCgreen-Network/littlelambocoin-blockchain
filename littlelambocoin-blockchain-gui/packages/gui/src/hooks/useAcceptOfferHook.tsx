import { OfferSummaryRecord } from '@littlelambocoin/api';
import { useTakeOfferMutation } from '@littlelambocoin/api-react';
import { AlertDialog, littlelambocoinToMojo, useOpenDialog, useShowError } from '@littlelambocoin/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? littlelambocoinToMojo(fee) : new BigNumber(0);
