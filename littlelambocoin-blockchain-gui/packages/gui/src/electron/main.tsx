        ...
        submenu: [
          {
            ...
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/littlelambocoin-blockchain/wiki');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/littlelambocoin-blockchain/wiki/FAQ');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Release Notes' }),
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/littlelambocoin-blockchain/releases');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/littlelambocoin-blockchain/blob/main/CONTRIBUTING.md');
            },
          },
          {
            type: 'separator',
          },
          {
            ...
            click: () => {
              openExternal('https://github.com/BTCgreen-Network/littlelambocoin-blockchain/issues');
            },
          },
          {
