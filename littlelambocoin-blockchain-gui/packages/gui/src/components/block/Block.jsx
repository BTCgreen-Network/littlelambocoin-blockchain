...
export default function Block() {
  ...
  const baseFarmerReward = mojoToLittlelambocoin(calculateBaseFarmerReward(blockRecord.height));

  const littlelambocoinFees = blockRecord.fees !== undefined ? mojoToLittlelambocoin(blockRecord.fees) : '';
  ...
  return (
    <LayoutDashboardSub>
      <Card
        title={
          <Back variant="h5">
            <Trans>Block at height {blockRecord.height} in the Littlelambocoin blockchain</Trans>
          </Back>
        }
        action={
          <Flex gap={1}>
