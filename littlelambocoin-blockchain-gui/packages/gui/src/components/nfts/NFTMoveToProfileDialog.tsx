import { NFTInfo } from '@littlelambocoin/api';
import type { Wallet } from '@littlelambocoin/api';
import { useGetDIDsQuery, useGetNFTWallets, useSetNFTDIDMutation } from '@littlelambocoin/api-react';
import {
  AlertDialog,
  Button,
  ButtonLoading,
...
export function NFTMoveToProfileAction(props: NFTMoveToProfileActionProps) {
  ...
  async function handleSubmit(formData: NFTMoveToProfileFormData) {
    ...
    const feeInMojos = littlelambocoinToMojo(fee || 0);
    let isValid = true;
