...
import { useCreateOfferForIdsMutation } from '@littlelambocoin/api-react';
...
function OfferEditor(props: OfferEditorProps) {
  ...
  function updateOffer(
    ...
    if (assetWalletId > 0) {
      ...
      if (walletType === WalletType.STANDARD_WALLET) {
        mojoAmount = littlelambocoinToMojo(amount);
  ...
  async function onSubmit(formData: FormData) {
    ...
    let feeInMojos = littlelambocoinToMojo(formData.fee ?? 0);
