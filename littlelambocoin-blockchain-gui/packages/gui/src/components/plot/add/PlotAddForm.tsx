import { defaultPlotter, toBech32m, fromBech32m } from '@littlelambocoin/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@littlelambocoin/api-react';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@littlelambocoin/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.LITTLELAMBOCOINPOS),
  });
