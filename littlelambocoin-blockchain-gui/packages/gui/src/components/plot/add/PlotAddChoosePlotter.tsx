import { defaultPlotter, PlotterName } from '@littlelambocoin/api';
import type { Plotter, PlotterMap } from '@littlelambocoin/api';
import { useGetPlottersQuery } from '@littlelambocoin/api-react';
import { CardStep, Select, StateColor } from '@littlelambocoin/core';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => (a == PlotterName.LITTLELAMBOCOINPOS ? -1 : a.localeCompare(b)));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default Littlelambocoin Proof of Space plotter. If unsure, use the default Littlelambocoin Proof of Space plotter.
        </Trans>
      </Typography>
