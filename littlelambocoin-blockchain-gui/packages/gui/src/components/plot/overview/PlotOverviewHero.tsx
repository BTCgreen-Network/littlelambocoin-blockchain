...
import { Button, CardHero, Flex, Link, useOpenDialog } from '@littlelambocoin/core';
import { Plots } from '@littlelambocoin/icons';
        ...
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              ...
              <Link target="_blank" href="https://github.com/BTCgreen-Network/littlelambocoin-blockchain/wiki/Network-Architecture">
                Learn more
              </Link>
            </Trans>
          </Typography>
