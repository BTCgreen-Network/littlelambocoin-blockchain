...
import { Flex, UnitFormat, More, Table, mojoToLittlelambocoinLocaleString, Suspender } from '@littlelambocoin/core';
...
import { WalletStatus } from '@littlelambocoin/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToLittlelambocoinLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
