import { Button, CardHero } from '@littlelambocoin/core';
import { Pooling } from '@littlelambocoin/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>Smooth out your LLC farming rewards by joining a pool.</Trans>
          </Typography>
