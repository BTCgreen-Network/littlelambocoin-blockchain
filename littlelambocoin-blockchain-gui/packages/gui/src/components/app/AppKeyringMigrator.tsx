import { useGetKeyringStatusQuery, useMigrateKeyringMutation } from '@littlelambocoin/api-react';
import { Button, AlertDialog, Flex, useOpenDialog, useValidateChangePassphraseParams, Suspender } from '@littlelambocoin/core';
      ...
      <DialogContent>
        ...
        {canSavePassphrase && (
          <Box display="flex" alignItems="center">
            ...
            />
            <Tooltip
              title={t`Your passphrase can be stored in your system's secure credential store. Littlelambocoin will be able to access your keys without prompting for your passphrase.`}
            >
