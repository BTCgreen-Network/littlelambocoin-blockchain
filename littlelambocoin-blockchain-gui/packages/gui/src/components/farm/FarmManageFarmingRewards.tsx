import { fromBech32m } from '@littlelambocoin/api';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@littlelambocoin/api-react';
import { Button, Flex, Form, TextField, Loading } from '@littlelambocoin/core';
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    and the 0.25LLC reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
