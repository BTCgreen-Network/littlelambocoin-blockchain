import { useCreateNewPoolWalletMutation } from '@littlelambocoin/api-react';
import { Flex, Suspender } from '@littlelambocoin/core';
  ...
  return (
    <>
      ...
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent LLC farming rewards. The average returns are the same, but it is much less
