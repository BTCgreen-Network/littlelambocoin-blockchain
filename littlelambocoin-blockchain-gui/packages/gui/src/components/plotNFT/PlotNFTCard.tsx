import { useDeleteUnconfirmedTransactionsMutation } from '@littlelambocoin/api-react';
import {
  Button,
  TooltipTypography,
  Flex,
...
import { Plot as PlotIcon } from '@littlelambocoin/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={mojoToLittlelambocoinLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
