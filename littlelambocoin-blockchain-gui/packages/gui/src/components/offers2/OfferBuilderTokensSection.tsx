...
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@littlelambocoin/core';
import { Tokens } from '@littlelambocoin/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Littlelambocoin Asset Tokens (CATs) are tokens built on top of LLC</Trans>}
