...
import { useGetWalletsQuery, useCreateOfferForIdsMutation } from '@littlelambocoin/api-react';
import { Flex, ButtonLoading, useOpenDialog, Loading } from '@littlelambocoin/core';
...
type createDefaultValuesParams = {
  walletType?: WalletType; // CAT or STANDARD_WALLET (LLC), indicates whether a token or CAT has a default entry
...
export function createDefaultValues(params: createDefaultValuesParams): OfferBuilderData {
  ...
  return {
    ...
    offered: {
      ...
      llc: walletType === WalletType.STANDARD_WALLET ? [{ amount: '' }] : [],
