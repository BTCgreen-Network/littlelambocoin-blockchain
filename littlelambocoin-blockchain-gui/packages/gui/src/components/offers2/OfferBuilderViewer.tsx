import { useGetWalletsQuery, useCheckOfferValidityMutation } from '@littlelambocoin/api-react';
import { Flex, ButtonLoading, Link, Loading, useShowError } from '@littlelambocoin/core';
        ...
        {error ? (
          ...
          <Alert severity="error">
            <Trans>
              ...
              <Link
                target="_blank"
                href="https://littlelambocoinlisp.com/docs/tutorials/offers_gui_tutorial/#taker-attempts-to-accept-an-invalid-offer"
              >
                here
              </Link>{' '}
              to learn more.
