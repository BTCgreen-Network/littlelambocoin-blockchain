...
from littlelambocoin.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from littlelambocoin.rpc.data_layer_rpc_util import marshal
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "littlelambocoin_data_layer"
