...
from littlelambocoin.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
...
from littlelambocoin.protocols.harvester_protocol import (
    Plot,
    PlotSyncDone,
    PlotSyncIdentifier,
    PlotSyncPathList,
...
from littlelambocoin.server.ws_connection import NodeType, ProtocolMessageTypes, WSLittlelambocoinConnection, make_msg
...
class Sender:
    ...
    _connection: Optional[WSLittlelambocoinConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSLittlelambocoinConnection) -> None:
