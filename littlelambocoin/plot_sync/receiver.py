...
from littlelambocoin.plot_sync.exceptions import (
...
from littlelambocoin.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
class Receiver:
    _connection: WSLittlelambocoinConnection
    _current_sync: Sync
    _last_sync: Sync
    ...
    def connection(self) -> WSLittlelambocoinConnection:
