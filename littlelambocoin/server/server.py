...
from littlelambocoin.util.network import is_in_network, is_localhost, select_port
...
class LittlelambocoinServer:
    ...
    async def start_server(self, on_connect: Callable = None):
        ...
        if authenticate:
            ...
            ssl_context = ssl_context_for_server(
                self.littlelambocoin_ca_crt_path, self.littlelambocoin_ca_key_path, self.p2p_crt_path, self.p2p_key_path, log=self.log
            )
