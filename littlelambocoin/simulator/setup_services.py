...
from littlelambocoin.cmds.init_funcs import init
...
from littlelambocoin.data_layer.data_layer_api import DataLayerAPI
from littlelambocoin.protocols.shared_protocol import Capability, capabilities
from littlelambocoin.server.start_data_layer import create_data_layer_service
from littlelambocoin.server.start_farmer import create_farmer_service
from littlelambocoin.server.start_full_node import create_full_node_service
from littlelambocoin.server.start_harvester import create_harvester_service
from littlelambocoin.server.start_introducer import create_introducer_service
from littlelambocoin.server.start_timelord import create_timelord_service
from littlelambocoin.server.start_wallet import create_wallet_service
from littlelambocoin.simulator.block_tools import BlockTools
from littlelambocoin.simulator.keyring import TempKeyring
from littlelambocoin.simulator.start_simulator import create_full_node_simulator_service
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["llc_spam_amount"] = llc_spam_amount
...
async def setup_farmer(
    ...
    service_config["llc_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "llc")
