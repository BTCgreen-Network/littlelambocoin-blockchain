...
def supports_keyring_passphrase() -> bool:
    # Support can be disabled by setting LITTLELAMBOCOIN_PASSPHRASE_SUPPORT to 0/false
    return os.environ.get("LITTLELAMBOCOIN_PASSPHRASE_SUPPORT", "true").lower() in ["1", "true"]
