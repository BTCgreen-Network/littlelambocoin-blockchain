...
from littlelambocoin.cmds.cmds_util import transaction_submitted_msg, transaction_status_msg
...
async def send(args: dict, wallet_client: WalletRpcClient, fingerprint: int) -> None:
    ...
    if typ == WalletType.STANDARD_WALLET:
        ...
        final_min_coin_amount = uint128(int(min_coin_amount * units["littlelambocoin"]))
