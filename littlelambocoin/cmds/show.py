...
from littlelambocoin.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'littlelambocoin show -c' has been renamed to 'littlelambocoin peer -c' ")
    if add_connection != "":
        print("'littlelambocoin show -a' has been renamed to 'littlelambocoin peer -a' ")
    if remove_connection != "":
        print("'littlelambocoin show -r' has been renamed to 'littlelambocoin peer -r' ")
    if wallet_rpc_port is not None:
        print("'littlelambocoin show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
