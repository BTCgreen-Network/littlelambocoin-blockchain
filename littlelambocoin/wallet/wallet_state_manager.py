...
from littlelambocoin.consensus.coinbase import farmer_parent_id, pool_parent_id
...
from littlelambocoin.data_layer.dl_wallet_store import DataLayerStore
...
from littlelambocoin.wallet.cat_wallet.cat_utils import construct_cat_puzzle, match_cat_puzzle
from littlelambocoin.wallet.cat_wallet.cat_wallet import CATWallet
from littlelambocoin.wallet.db_wallet.db_wallet_puzzles import MIRROR_PUZZLE_HASH
...
from littlelambocoin.wallet.did_wallet.did_wallet_puzzles import DID_INNERPUZ_MOD, create_fullpuz, match_did_puzzle
from littlelambocoin.wallet.key_val_store import KeyValStore
from littlelambocoin.wallet.nft_wallet.nft_info import NFTWalletInfo
from littlelambocoin.wallet.nft_wallet.nft_puzzles import get_metadata_and_phs, get_new_owner_did
...
from littlelambocoin.wallet.notification_manager import NotificationManager
from littlelambocoin.wallet.outer_puzzles import AssetType
from littlelambocoin.wallet.puzzle_drivers import PuzzleInfo
from littlelambocoin.wallet.puzzles.cat_loader import CAT_MOD, CAT_MOD_HASH
...
from littlelambocoin.wallet.util.address_type import AddressType
...
from littlelambocoin.wallet.util.wallet_sync_utils import last_change_height_cs, PeerRequestException
...
from littlelambocoin.wallet.wallet_retry_store import WalletRetryStore
...
class WalletStateManager:
    ...
    async def filter_spam(self, new_coin_state: List[CoinState]) -> List[CoinState]:
        llc_spam_amount = self.config.get("llc_spam_amount", 0)
        ...
        small_unspent_count = await self.coin_store.count_small_unspent(llc_spam_amount)
        ...
        for cs in new_coin_state:
            ...
            if (
                ...
                and cs.coin.amount < llc_spam_amount
    ...
    async def get_minter_did(self, launcher_coin: Coin, peer: WSLittlelambocoinConnection) -> Optional[bytes32]:
        # Get minter DID
