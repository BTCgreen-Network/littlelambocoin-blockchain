...
from littlelambocoin.consensus.coinbase import farmer_parent_id, pool_parent_id, timelord_parent_id
...
from littlelambocoin.protocols.wallet_protocol import CoinState, PuzzleSolutionResponse, RespondPuzzleSolution
