...
from littlelambocoin.full_node.weight_proof import (
...
def _create_shutdown_file() -> IO:
    return tempfile.NamedTemporaryFile(prefix="littlelambocoin_wallet_weight_proof_handler_executor_shutdown_trigger")
