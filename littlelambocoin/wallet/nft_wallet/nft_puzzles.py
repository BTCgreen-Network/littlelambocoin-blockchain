...
from littlelambocoin.wallet.nft_wallet.nft_info import NFTCoinInfo, NFTInfo
from littlelambocoin.wallet.nft_wallet.nft_off_chain import get_off_chain_metadata
...
from littlelambocoin.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import solution_for_conditions
...
def metadata_to_program(metadata: Dict[bytes, Any]) -> Program:
    """
    Convert the metadata dict to a Littlelambocoinlisp program
    :param metadata: User defined metadata
    :return: Littlelambocoinlisp program
    """
    kv_list = []
...
def program_to_metadata(program: Program) -> Dict[bytes, Any]:
    ...
    :param program: Littlelambocoinlisp program contains the metadata
