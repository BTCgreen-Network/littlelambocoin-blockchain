...
required to run a [Timelord](https://github.com/Littlelambocoin-Network/littlelambocoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Littlelambocoin-Network/littlelambocoin-blockchain/blob/main/install-timelord.sh)
