...
required to run a [Timelord](https://github.com/LittlelambocoinNetwork/littlelambocoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/LittlelambocoinNetwork/littlelambocoin-blockchain/blob/main/install-timelord.sh)
