...
kwargs = dict(
    ...
    author="Dommer",
    author_email="dommer@littlelambocoin.com",
    ...
    zip_safe=False,
    project_urls={
        "Source": "https://github.com/Littlelambocoin-Network/littlelambocoin-blockchain/",
        "Changelog": "https://github.com/Littlelambocoin-Network/littlelambocoin-blockchain/blob/main/CHANGELOG.md",
    },
)
